...
class Type2PaymentProcessorTest {
    ...
    void whenValidate_thenReturnValidatedPayment() {
        assertThat(type2PaymentProcessor.validate(providePayment(), providePaymentRequestDTO())).isEqualTo(provideValidatedPayment());
    }
    ...
    void whenValidatePayment_withNotValidCurrency_thenThrowRequestValidationException() {
        ...
        assertThrows(RequestValidationException.class, () -> type2PaymentProcessor.validate(payment, requestDTO));
    }
